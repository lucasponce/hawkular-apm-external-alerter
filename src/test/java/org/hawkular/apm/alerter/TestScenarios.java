...
public class TestScenarios {
    ...
    public static Collection<Event> marketingScenario() {
        ...
        Event e2 = new Event(TEST_TENANT, uuid(), now + 1000, DATA_ID, "TraceCompletion", "Buy Music");
        e2.addTag("duration", "2000");
        e2.addTag("accountId", "user1");
        Event e3 = new Event(TEST_TENANT, uuid(), now + 2000, DATA_ID, "TraceCompletion", "Buy Groceries");
        e3.addTag("duration", "1500");
        e3.addTag("accountId", "user1");
        Event e4 = new Event(TEST_TENANT, uuid(), now + 3000, DATA_ID, "TraceCompletion", "Buy VideoGames");
        e4.addTag("duration", "3000");
        e4.addTag("accountId", "user1");
        Event e5 = new Event(TEST_TENANT, uuid(), now + 4000, DATA_ID, "TraceCompletion", "Buy VideoGames");
        ...
        Event e7 = new Event(TEST_TENANT, uuid(), now + 5000, DATA_ID, "TraceCompletion", "Buy Music");
        e7.addTag("duration", "2000");
        e7.addTag("accountId", "user2");
        Event e8 = new Event(TEST_TENANT, uuid(), now + 10000, DATA_ID, "TraceCompletion", "Buy Groceries");
    ...
    public static Collection<Event> fraudScenario() {
        ...
        Event e7 = new Event(TEST_TENANT, uuid(), now + 15000, DATA_ID, "TraceCompletion", "Buy Music");
        e7.addTag("duration", "2000");
        e7.addTag("accountId", "user2");
        e7.addTag("location", "ip4");
        Event e8 = new Event(TEST_TENANT, uuid(), now + 20000, DATA_ID, "TraceCompletion", "Buy Groceries");
        e8.addTag("duration", "1500");
        e8.addTag("accountId", "user2");
        ...
        Event e12 = new Event(TEST_TENANT, uuid(), now + 1000, DATA_ID, "TraceCompletion", "Buy Music");
        e12.addTag("duration", "2000");
        e12.addTag("accountId", "user3");
        e12.addTag("location", "ip10");
        Event e13 = new Event(TEST_TENANT, uuid(), now + 2000, DATA_ID, "TraceCompletion", "Buy Groceries");
        e13.addTag("duration", "1500");
        e13.addTag("accountId", "user3");
        e13.addTag("location", "ip10");
        Event e14 = new Event(TEST_TENANT, uuid(), now + 3000, DATA_ID, "TraceCompletion", "Buy VideoGames");
        e14.addTag("duration", "3000");
        e14.addTag("accountId", "user3");
        e14.addTag("location", "ip10");
        Event e15 = new Event(TEST_TENANT, uuid(), now + 4000, DATA_ID, "TraceCompletion", "Buy VideoGames");
    ...
    public static Collection<Event> customerRetentionScenario() {
        ...
        e1.addTag("accountId", "user1");
        Event e2 = new Event(TEST_TENANT, uuid(), now + 1, DATA_ID, "Stock Check", "Out of Stock");
        e2.addTag("duration", "2000");
        e2.addTag("traceId", "trace1");
        e2.addTag("accountId", "user1");

        Event e3 = new Event(TEST_TENANT, uuid(), now + 2, DATA_ID, "Credit Check", "Good");
        e3.addTag("duration", "1500");
        e3.addTag("traceId", "trace2");
        e3.addTag("accountId", "user1");
        Event e4 = new Event(TEST_TENANT, uuid(), now + 3, DATA_ID, "Stock Check", "Out of Stock");
        e4.addTag("duration", "2000");
        e4.addTag("traceId", "trace2");
        e4.addTag("accountId", "user1");

        Event e5 = new Event(TEST_TENANT, uuid(), now + 4, DATA_ID, "Credit Check", "Exceptionally Good");
        e5.addTag("duration", "1500");
        e5.addTag("traceId", "trace3");
        e5.addTag("accountId", "user1");
        Event e6 = new Event(TEST_TENANT, uuid(), now + 5, DATA_ID, "Stock Check", "Available");
        ...
        Event e12 = new Event(TEST_TENANT, uuid(), now + 1, DATA_ID, "Stock Check", "Out of Stock");
        e12.addTag("duration", "2000");
        e12.addTag("traceId", "trace4");
        e12.addTag("accountId", "user2");

        Event e13 = new Event(TEST_TENANT, uuid(), now + 2, DATA_ID, "Credit Check", "Good");
        e13.addTag("duration", "1500");
        ...
        Event e15 = new Event(TEST_TENANT, uuid(), now + 4, DATA_ID, "Credit Check", "Exceptionally Good");
        e15.addTag("duration", "1500");
        e15.addTag("traceId", "trace6");
        e15.addTag("accountId", "user2");
        Event e16 = new Event(TEST_TENANT, uuid(), now + 5, DATA_ID, "Stock Check", "Available");
