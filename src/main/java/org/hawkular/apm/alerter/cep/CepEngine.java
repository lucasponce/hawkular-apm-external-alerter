...
public class CepEngine {
    private final Logger log = Logger.getLogger(CepEngine.class);
    ...
    public void updateConditions(Collection<FullTrigger> activeTriggers) {
        ...
        kieSession.setGlobal("cepEngine", this);
